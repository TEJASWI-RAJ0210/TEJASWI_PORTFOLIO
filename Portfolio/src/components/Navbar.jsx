...
const Navbar = () => {
    return (
        <header className="fixed top-0 left-0 right-0 bg-black/80 py-5">
            ...
            <div className="hidden md:block">
                <button className="relative rounded-full font-medium overflow-hidden px-4 py-2 text-sm bg-[#1DA1F2] text-white hover:bg-[#1a2329]"><span className="relative flex items-center justify-center gap-2"><a href="#Contact">Contact Me</a></span></button>
